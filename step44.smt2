; file: D:\Entwicklung\workspace\alloy2relsmt\com-search-first-half\step44.als 
; hash: 1AFE63 D4685 3593D5CAD2A5A8092D9
(set-logic AUFLIA)
...
(assert 
 (! 
  (not (not (exists ((i Atom)) (and (in_1 i LegalInterface) (not (subset_1 (join_1x2 (a2r_1 i) iids1) (join_1x2 (a2r_1 i) iidsKnown))))))) 
 :named command8e8cb4d9 
 ) 
 )
;; --end command
