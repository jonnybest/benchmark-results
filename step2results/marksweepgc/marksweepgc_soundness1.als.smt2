...
(assert 
 (! 
  (forall ((hs Rel1)(from Rel1)(hs_ Rel1)) (= (mark hs from hs_) (and 
    (subset_1 (join_1x2 hs_ marked) (reachable hs from))
    (subset_1 (reachable hs from) (join_1x2 hs_ marked))
    (and (subset_2 (join_1x3 hs_ left) (join_1x3 hs left)) (subset_2 (join_1x3 hs left) (join_1x3 hs_ left)))
    (and (subset_2 (join_1x3 hs_ right) (join_1x3 hs right)) (subset_2 (join_1x3 hs right) (join_1x3 hs_ right)))
  ))) 
 :named assert386d179 
 ) 
 )
...
(assert 
 (! 
  (forall ((hs Rel1)(hs_ Rel1)) (= (setFreeList hs hs_) (and 
    ...
    (subset_1 (join_1x2 (a2r_1 n) (join_1x3 hs_ left)) (join_1x2 (a2r_1 n) (join_1x3 hs left)))
    (subset_1 (join_1x2 (a2r_1 n) (join_1x3 hs left)) (join_1x2 (a2r_1 n) (join_1x3 hs_ left)))
    (and (subset_1 (join_1x2 (a2r_1 n) (join_1x3 hs_ right)) (join_1x2 (a2r_1 n) (join_1x3 hs right))) (subset_1 (join_1x2 (a2r_1 n) (join_1x3 hs right)) (join_1x2 (a2r_1 n) (join_1x3 hs_ right))))
  ))))
    (and (subset_1 (join_1x2 hs_ marked) (join_1x2 hs marked)) (subset_1 (join_1x2 hs marked) (join_1x2 hs_ marked)))
  ))) 
 :named assertfdd04d89 
 ) 
 )
;; --end assertions
...
(assert 
 (! 
  (not (forall ((h Atom)(h_ Atom)(root Atom)) (=> (and 
    ...
    (in_1 h_ HeapState)
    (in_1 root Node)
  ) (=> (GC (a2r_1 h) (a2r_1 root) (a2r_1 h_)) (forall ((live Atom)) (=> (and (in_1 live Node) (in_1 live (reachable (a2r_1 h) (a2r_1 root)))) (and 
    (subset_1 (join_1x2 (a2r_1 live) (join_1x3 (a2r_1 h_) left)) (join_1x2 (a2r_1 live) (join_1x3 (a2r_1 h) left)))
    (subset_1 (join_1x2 (a2r_1 live) (join_1x3 (a2r_1 h) left)) (join_1x2 (a2r_1 live) (join_1x3 (a2r_1 h_) left)))
    (and (subset_1 (join_1x2 (a2r_1 live) (join_1x3 (a2r_1 h_) right)) (join_1x2 (a2r_1 live) (join_1x3 (a2r_1 h) right))) (subset_1 (join_1x2 (a2r_1 live) (join_1x3 (a2r_1 h) right)) (join_1x2 (a2r_1 live) (join_1x3 (a2r_1 h_) right))))
  ))))))) 
 :named commandfc6d92f8 
 ) 
 )
;; --end command
