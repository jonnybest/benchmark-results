...
(assert 
 (! 
  (not (forall ((c1 Atom)(c2 Atom)) (=> (and (in_1 c1 Component) (in_1 c2 LegalComponent)) (=> (some_1 (inter_1 (join_1x2 (a2r_1 c1) interfaces) (join_1x2 (a2r_1 c2) interfaces))) (subset_1 (join_1x2 (a2r_1 c2) iids1) (join_1x2 (a2r_1 c1) iids1)))))) 
 :named command84b03e62 
 ) 
 )
;; --end command
