; file: /amd.home/home/best/experiment/com/com_th3.als 
; hash: 14ABB54C9D1786BD132D8235AE3A7518
(set-logic AUFLIA)
...
(assert 
 (! 
  (not (forall ((outer Atom)) (=> (in_1 outer Component) (forall ((inner Atom)) (=> (and (in_1 inner Component) (in_1 inner (join_1x2 (a2r_1 outer) aggregates))) (in_1 inner (join_1x2 (a2r_1 outer) eqs))))))) 
 :named commandd88b3dd3 
 ) 
 )
;; --end command
