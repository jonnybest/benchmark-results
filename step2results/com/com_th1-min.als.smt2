; file: /amd.home/home/best/experiment/com/com_th1-min.als 
; hash: 1DD16526B2E8 5 E2AF3643AA16F DE0
(set-logic AUFLIA)
...
(assert 
 (! 
  (forall ((i Atom)) (=> (in_1 i Interface) (and (subset_1 (join_1x2 (a2r_1 i) reaches) (join_1x2 IID (join_1x3 (a2r_1 i) qi))) (subset_1 (join_1x2 IID (join_1x3 (a2r_1 i) qi)) (join_1x2 (a2r_1 i) reaches))))) 
 :named assert1ba5ae57 
 ) 
 )
(assert 
 (! 
...
(assert 
 (! 
  (forall ((c Atom)) (=> (in_1 c Component) (and (subset_1 (join_1x2 (a2r_1 c) iids1) (join_1x2 (join_1x2 (a2r_1 c) interfaces) iids)) (subset_1 (join_1x2 (join_1x2 (a2r_1 c) interfaces) iids) (join_1x2 (a2r_1 c) iids1))))) 
 :named assert4d7ce71f 
 ) 
 )
(assert 
 (! 
...
(assert 
 (! 
  (not (forall ((c Atom)) (=> (in_1 c LegalComponent) (forall ((i Atom)) (=> (and (in_1 i Interface) (in_1 i (join_1x2 (a2r_1 c) interfaces))) (and (subset_1 (join_1x2 (a2r_1 c) iids1) (join_1x2 (a2r_1 i) iidsKnown)) (subset_1 (join_1x2 (a2r_1 i) iidsKnown) (join_1x2 (a2r_1 c) iids1)))))))) 
 :named command462a08d0 
 ) 
 )
;; --end command
