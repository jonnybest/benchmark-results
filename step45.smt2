; file: D:\Entwicklung\workspace\alloy2relsmt\com-search-first-half\step45.als 
; hash: 6AA5DC843BA493AB6098D934A54BC73D
(set-logic AUFLIA)
...
(assert 
 (! 
  (not (forall ((c Atom)) (=> (in_1 c Component) (forall ((i Atom)) (=> (and (in_1 i Interface) (in_1 i (join_1x2 (a2r_1 c) interfaces))) (subset_1 (join_1x2 (a2r_1 i) iids1) (join_1x2 (join_1x2 (a2r_1 c) interfaces) iids1))))))) 
 :named commanda71fb9a5 
 ) 
 )
;; --end command
