; file: D:\Entwicklung\workspace\alloy2relsmt\com-search\step3.als 
; hash: 8E7DBCB0D42E2FCA47AB92FFDF64A753
(set-logic AUFLIA)
...
(assert 
 (! 
  (not (not (exists ((c Atom)) (and (in_1 c LegalComponent) (exists ((i Atom)) (and 
    ...
    (or (exists ((o Atom)) (and 
    (in_1 o IID)
    (in_1 o (join_1x2 (a2r_1 i) iidsKnown))
    (not (in_1 o (join_1x2 (a2r_1 c) iids1)))
  )) (exists ((o Atom)) (and 
    (in_1 o IID)
