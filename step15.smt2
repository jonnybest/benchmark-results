; file: D:\Entwicklung\workspace\alloy2relsmt\com-search-first-half\step15.als 
; hash: A0 BFE37ED6E149DA65D7594B22DBCEA
(set-logic AUFLIA)
...
(assert 
 (! 
  (not (not (exists ((c Atom)) (and (in_1 c LegalComponent) (exists ((o Atom)) (and 
    (in_1 o IID)
    (in_1 o (join_1x2 (join_1x2 (a2r_1 c) interfaces) iids1))
    (not (in_1 o (join_1x2 (join_1x2 (a2r_1 c) interfaces) iids1)))
  )))))) 
 :named command99931022 
 ) 
 )
;; --end command
