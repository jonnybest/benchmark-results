; file: D:\Entwicklung\workspace\alloy2relsmt\com-search-first-half\stepA1.als 
; hash:  CE3394B65325DE49367494D45E58D9C
(set-logic AUFLIA)
...
(assert 
 (! 
  (not (forall ((c Atom)) (=> (in_1 c LegalComponent) (forall ((i Atom)) (=> (and (in_1 i Interface) (in_1 i (join_1x2 (a2r_1 c) interfaces))) (in_1 i LegalInterface)))))) 
 :named commande01f3dd1 
 ) 
 )
;; --end command
