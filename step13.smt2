; file: D:\Entwicklung\workspace\alloy2relsmt\com-search-first-half\step13.als 
; hash: 14FC7CC7 4AA2B715462 BC0AF643AC3
(set-logic AUFLIA)
...
(assert 
 (! 
  (not (not (exists ((c Atom)) (and (in_1 c LegalComponent) (exists ((o Atom)) (and 
    ...
    (not (in_1 o (join_1x2 (a2r_1 c) iids)))
  )))))) 
 :named command88241ebe 
 ) 
 )
;; --end command
