; file: D:\Entwicklung\workspace\alloy2relsmt\com-search-first-half\step9.als 
; hash: 5E3EEF 8FE29221A743C642EBFBAFE55
(set-logic AUFLIA)
...
(assert 
 (! 
  (not (not (exists ((c Atom)) (and (in_1 c LegalComponent) (exists ((i Atom)) (and 
    ...
    (exists ((o Atom)) (and 
    (in_1 o IID)
    (in_1 o (join_1x2 (a2r_1 i) iidsKnown))
    (and (in_1 o (join_1x2 (join_1x2 (a2r_1 o) (join_1x3 (a2r_1 i) qi)) iids)) (not (in_1 o (join_1x2 (a2r_1 c) iids1))))
  ))
  )))))) 
 :named commandcf608904 
 ) 
 )
;; --end command
