; file: D:\Entwicklung\workspace\alloy2relsmt\com-search-first-half\step12.als 
; hash: 9B6590B4 1F15648 3EAA3252FDC7115
(set-logic AUFLIA)
...
(assert 
 (! 
  (not (forall ((c Atom)) (=> (in_1 c LegalComponent) (forall ((i Atom)) (=> (and (in_1 i Interface) (in_1 i (join_1x2 (a2r_1 c) interfaces))) (forall ((o Atom)) (=> (and (in_1 o IID) (in_1 o (join_1x2 (a2r_1 i) iidsKnown))) (in_1 o IID)))))))) 
 :named command61ef58ba 
 ) 
 )
;; --end command
